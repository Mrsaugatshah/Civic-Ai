  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-background">
      ...
      <main>
          ...
          <div className="relative mx-auto max-w-3xl px-4 py-20 text-center sm:px-6 sm:py-28">
            <Reveal>
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3">
                <Button size="lg" asChild><Link to={reportTarget}>Report an Issue <ArrowRight size={16} /></Link></Button>
        ...
        <section id="how-it-works" className="scroll-mt-20 border-b bg-card py-16 sm:py-20">
        ...
        <section id="community" className="scroll-mt-20 border-b bg-card py-16 sm:py-20">
